...
Route::group([ 'prefix' => 'v1', 'middleware' => ['api', 'cors']], function() {
    ...
    Route::group([ 'prefix' => 'admin', 'middleware' => 'isAdmin' ], function() {
        ...
        /* Get all Baggages details */
        Route::get('/baggages', 'App\Http\Controllers\Api\v1\BaggageController@getAll');
        /* Get all Flight Check IN Baggages */
        
        /* Sendgrid email */
        //Route::put('/sendgrid/email', 'App\Http\Controllers\Api\v1\EmailController@email');
        //Route::put('/sendgrid/email', 'App\Http\Controllers\Api\v1\SendgridController@email');

        /* SMS message */
        Route::put('/sendgrid/email', 'App\Http\Controllers\Api\v1\SendgridController@sms');
        ...
        /* Get edit aircraft_flights */
        Route::get('/checkin/aircraft_flight/{aircraftFlightId}', 'App\Http\Controllers\Api\v1\AircraftFlightController@getAircraftFlightsById');
        /*Update the checkin aircraft flight*/
        Route::put('/checkin/flight/update', 'App\Http\Controllers\Api\v1\AircraftFlightController@updateAircraftFlight');
