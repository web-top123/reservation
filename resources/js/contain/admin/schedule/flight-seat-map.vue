                ...
                <ol class="cabin fuselage">
                  <li class="row" v-for="i in 20" :key="i">
                    <ol class="seats" type="A">
                      <li class="seat">
                        <input type="checkbox" v-model="seats[i+'A']" :id="i+'A'" @click = "selectSeat(i+'A')"/>
                        <label :for="i+'A'">{{i}}A</label>
                      </li>
                      <li class="seat" style="margin-right:20px">
                        <input type="checkbox" v-model="seats[i+'B']" :id="i+'B'" @click = "selectSeat(i+'B')"/>
                        <label :for="i+'B'">{{i}}B</label>
                      </li>
                      <li class="seat">
                        <input type="checkbox" v-model="seats[i+'C']" :id="i+'C'" @click = "selectSeat(i+'C')"/>
                        <label :for="i+'C'">{{i}}C</label>
                      </li>
                      <li class="seat">
                        <input type="checkbox" v-model="seats[i+'D']" :id="i+'D'" @click = "selectSeat(i+'D')"/>
